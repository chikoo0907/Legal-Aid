...
const videoData = [
  {
    id: "1",
    videoUrl:
      "https://drive.google.com/uc?export=download&id=1T-L_qH6xZFxOf2gOyiKLZPkS6MMZa-CY",
    titleKey: "videoTitle1",
    descKey: "videoDesc1",
    categoryKey: "videoCategory1",
  },
  {
    id: "2",
    videoUrl:
      "https://drive.google.com/uc?export=download&id=1nzI_oV-pw9Y2NHclBr5SBiA6MwASglWr",
    titleKey: "videoTitle2",
    descKey: "videoDesc2",
    categoryKey: "videoCategory2",
  },
  {
    id: "3",
    videoUrl:
...
export default function Awareness({ navigation }) {
  ...
  const renderItem = useCallback(
    ({ item, index }) => {
      ...
      return (
        <View
          className="mx-4 mt-4 rounded-xl overflow-hidden bg-black"
          style={{ height: videoHeight }}
        >
          {/* Video Player */}
          <Video
